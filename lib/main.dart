    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF4A148C), // Deep Purple from your design
          brightness: Brightness.light,
        ),
        useMaterial3: true,
        fontFamily: 'Roboto', // Standard Android font for clean UI
      ),
...
class _MainNavigationShellState extends State<MainNavigationShell> {
  ...
  // Placeholder screens for your 4 main tabs
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // WhatsApp Active Status Indicator
          Padding(
...
// Temporary Dashboard UI to match your mockup layout
